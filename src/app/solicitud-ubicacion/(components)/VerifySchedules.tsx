...
function BlockDialog(){
	return(
		<>
        <Image
          src={alertImage.src} // Reemplazar con tu propia imagen
          alt="Advertencia"
		  width={100}
		  height={100}
          style={{
        ...
        <span>
		  ...
		  alguna duda, comuníquese con nosotros a través de nuestro correo: 
		  <strong>ciunac.alumnosnuevos@unac.edu.pe</strong> o al telfono: <strong>014291931</strong>
        </span>
      </>
	)
}